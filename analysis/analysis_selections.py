...
import pofah.experiment as exp
...
if __name__ == '__main__':
    ...
    # quantiles = [0.9]
    mjj_key = 'mJJ'
    param_dict = {'$run$': str(run), '$sig_name$': sample_ids[1], '$sig_xsec$': str(int(sig_xsec))}
    ...
    fig_dir = exp.Experiment(run_n=params.run_n, param_dict=param_dict).setup(analysis_dir_qr=True).analysis_dir_qr_mjj
